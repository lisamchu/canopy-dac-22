...
urb_rur_odds_lab <- data.frame(x = c(urb_rur_odds$short_name),
                           y = c(1 + urb_rur_odds$urb_rur_ratio),
                           lab = c("17.7x", "13.8x", "13.2x", "12.4x", "10.1x", "7.5x", "7.5x", "7.4x", "7x", "6.4x", "6.3x", "6.3x", "6.2x", "6x", "6x"))
#viz
...
urb_sub_odds_lab <- data.frame(x = c(urb_sub_odds$short_name),
                           y = c(1 + urb_sub_odds$urb_sub_ratio),
                           lab = c("6.5x", "6.5x", "6.3x", "6.3x", "6x", "6x", "5.8x", "5.75x", "5.5x", "5.4x", "5x", "5x", "5x", "4.8x", "4.7x"))
#viz
urb_sub_odds_viz <- urb_sub_odds %>% 
  ...
  labs(x = "",
       ...
       subtitle = "as compared to suburban schools using raw odds ratios \n
                  Note: dual language programming left out because no suburban schools selected it)")
...
sub_rur_odds_lab <- data.frame(x = c(sub_rur_odds$short_name),
                           y = c(.25 + sub_rur_odds$sub_rur_ratio),
                           lab = c("3x", "3x", "2.5x", "2.3x", "2.3x", "2x", "2x", "2x", "2x", "1.9x", "1.8x", "1.6x", "1.6x", "1.6x", "1.5x"))
#viz
