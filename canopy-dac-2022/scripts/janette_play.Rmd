...
### Convert `nces_race_values` to percentages

```{r nces race percentages}
View(data.frame(colnames(clean_dac_22)))
#relevant cols (numerator):
#197 = "nces_race_black"
#198 = "nces_race_nhpi"
#199 = "nces_race_asian"
#200 = "nces_race_hispanic"
#201 = "nces_race_aian"
#relevant cols (denom):
#181 = "nces_totall_enrollment"
View(clean_dac_22[,181])
View(clean_dac_22[,197:201])
View(clean_dac_22$nces_total_enrollment)

sum(is.na(clean_dac_22$self_reported_race_white))
```
